import r$1, { useRef, useDebugValue, useContext, createElement, useState, useEffect, Children, useLayoutEffect } from 'react';
...
const SliderContentInner = ({
  ...
  return /*#__PURE__*/r$1.createElement("div", _extends({}, props, {
    size: size,
    ref: innerRef
  }), children);
};
...
const Carousel = ({
  ...
  const [size, setSize] = useState([0, 0]); // let slideSize =
  //   size[0] >= 1960
  ...
  return /*#__PURE__*/r$1.createElement(CarouselContainerStyled, null, /*#__PURE__*/r$1.createElement("div", {
    className: "secondary-container",
    style: { ...propsValues
    }
  }, /*#__PURE__*/r$1.createElement("span", {
  ...
  }, leftButton ? leftButton : /*#__PURE__*/r$1.createElement("button", {
    className: `custom-arrow-btn`
  }, /*#__PURE__*/r$1.createElement("span", {
    style: {
      fontSize: 25
    }
  }, "\u2039"))), /*#__PURE__*/r$1.createElement("div", {
    className: "slider-content-container"
  }, /*#__PURE__*/r$1.createElement(SliderContent, {
  ...
  }, children)), /*#__PURE__*/r$1.createElement("span", {
    ...
    title: "Next Slide"
  }, rightButton ? rightButton : /*#__PURE__*/r$1.createElement("button", {
    className: `custom-arrow-btn`
  }, /*#__PURE__*/r$1.createElement("span", {
    style: {
      fontSize: 25
...
const SliderContent = ({
  ...
  return /*#__PURE__*/r$1.createElement(SliderContentStyled, props, children);
};
...
const Slide = ({
  ...
  return /*#__PURE__*/r$1.createElement(SlideStyled, {
    className: "",
    size: size[0] >= 1960 ? breakpoints?.extraLargeScreen || 8 : size[0] >= 1440 ? breakpoints?.largeScreen || 5 : size[0] >= 769 ? breakpoints?.laptop || 3 : size[0] >= 481 ? breakpoints?.tab || 2 : breakpoints?.phone || 1
  }, children);
};
